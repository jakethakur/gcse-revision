...
var data  = {
	...
	software: [
		...
		},
		{
			...
			answer: ["compression", "defragmentation", "antivirus"],
			answerType: "match",
			required: 2,
			topic: "misc software",
		},
	...
	security: [
		...
		},
		{
			...
			answer: ["antivirus", "anti-malware", "update", "web filter", "firewall"],
			answerType: "match",
			required: 1,
			topic: "malware",
		},
		{
			...
			answer: ["acceptable use policy", "disaster recovery policy", "antivirus", "anti-malware", "penetration testing", "footprinting", "bounties", "bounty", "white-hat", "firewall", "ethical hacking", "web filter", "update"],
			answerType: "match",
			required: 1,
			topic: "data protection",
		},
		...
		},
		{
			...
			answer: ["length", "character", "symbol", "uppercase", "number", "alphanumeric"],
			answerType: "match",
			required: 1,
			topic: "data protection",
		},
		...
		},
		{
			...
			answer: ["shoulder surfing", "sql injection", "dos attack", "ddos attack", "ip address spoofing", "ip spoofing", "password"],
			answerType: "match",
			required: 1,
			topic: "cyberattack",
		},
