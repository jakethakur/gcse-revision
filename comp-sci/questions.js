...
var data  = {
	...
	communication: [
		...
		/*{
			question: "Fill in the blank: static routing is also known as _______ switching.",
			answer: "circuit",
			answerType: "exact",
			suddenDeath: true,
			topic: "routing",
		...
		{
			question: "Fill in the blank: dynamic routing is also known as ______ switching.",
			answer: "packet",
			answerType: "exact",
			suddenDeath: true,
			topic: "routing",
		...
		{
			question: "Does 'dynamic' or 'static' routing ensure the data packets arrive in order at the location?",
			answer: "static",
			answerType: "exact",
			suddenDeath: true,
			topic: "routing",
		...
		{
			question: "Does 'dynamic' or 'static' routing allow congested parts of the network to be avoided?",
			answer: "dynamic",
			answerType: "exact",
			suddenDeath: true,
			topic: "routing",
		},*/
		// tbd: IP addresses, DNS, MAC addresses? (check spec), network topologies, wired and wireless, network types, packets
	],
	data: [
